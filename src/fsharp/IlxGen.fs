...
and GetIlxClosureFreeVars cenv m selfv eenvouter takenNames expr =
    ...
    let cloInternalFreeTyvars = List.ofSeq(HashSetUtils.diff (new HashSet<Typar>(cloFreeVarResults.FreeTyvars.FreeTypars, typarEquality)) cloContractFreeTyvarSet)
